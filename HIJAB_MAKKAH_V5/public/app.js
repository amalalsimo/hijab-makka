  ...
  function productCardHtml(p) {
    ...
    return `
      <article class="product-card" data-product="${escapeHtml(p.id)}">
        <button class="product-image-wrap product-image-button" type="button" data-open-product="${escapeHtml(p.id)}" aria-label="فتح ${escapeHtml(p.name)}">
        ...
        <div class="product-body">
          ...
          ${p.has_size_options && sizes.length ? `
            <div class="card-option-block">
              <span class="card-option-label">المقاس</span>
          ...
          ${p.has_color_options && colors.length ? `
            <div class="card-option-block card-color-block">
              <span class="card-option-label">اللون</span>
